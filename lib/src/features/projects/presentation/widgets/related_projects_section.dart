...
class RelatedProjectsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final related = featuredProjects.where((p) => p.id != currentProjectId).toList();
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height: 550, // Increased height for larger cards
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return _ProjectCard(project: related[index]);
                      },
                    ),
                  ),
                ],
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                   Text(
                    project.category.isNotEmpty ? project.category : "PORTFOLIO",
